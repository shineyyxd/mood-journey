...
export const PARAMS = [
  ...
  // — 视觉 —
  { key: 'turbulence',      label: '湍流强度',     group: '视觉', min: 0,   max: 2,   step: 0.01, def: 1.0  },
  ...
  { key: 'aberration',      label: '色散(px)',     group: '视觉', min: 0,   max: 4,   step: 0.1,  def: 1.5  },
  { key: 'glow',            label: '弧线辉光',     group: '视觉', min: 0,   max: 2,   step: 0.05, def: 1.2  },
  { key: 'arcWidth',        label: '弧线宽度',     group: '视觉', min: 1,   max: 8,   step: 0.5,  def: 3    },
  { key: 'particles',       label: '粒子数量',     group: '视觉', min: 0,   max: 400, step: 10,   def: 160  },
...
export const STORAGE_KEY = 'claudiofm.v1';
